package com.doppioslash.androidtut;
...
import com.doppioslash.androidtut.R;
...
public class SplashActivity extends Activity {
    ...
    public void proceed() {
        startActivity(new Intent("com.doppioslash.androidtut.MAIN"));
        finish();
    }
    ...
    public void loadClojure() {
        new Thread(new Runnable(){
                ...
                public void run() {
                    ...
                    try {
                        Class.forName("com.doppioslash.androidtut.Reader");
                    } catch (ClassNotFoundException e) {
                        Log.e(TAG, "Failed loading Reader", e);
                    }
